...
describe('ProcessorRow.vue', () => {
  ...
  it('test converted time', () => {
    expect(ProcessorRow.methods.convertDate('2001-01-01 00:00:00')).to.equal('1st January 2001');
  ...
  it('Populate details', () => {
    ...
    expect(vm.$el.querySelector('.processorRow div:nth-child(2) label:nth-child(2)').textContent).to.equal('1st January 2001');
    expect(vm.$el.querySelector('.processorRow div:nth-child(3) label:nth-child(2)').textContent).to.equal('1st January 2001');
